...
model REGCA1 "Renewable energy generator/converter model A"
  ...
  OpenIPSL.Electrical.Renewables.PSSE.InverterInterface.BaseClasses.LVACM
  ...
  OpenIPSL.Electrical.Renewables.PSSE.InverterInterface.BaseClasses.LVPL
    LVPL(
    Brkpt=Brkpt,
    Lvpl1=Lvpl1,
    Zerox=Zerox)
