...
extends OpenIPSL.Electrical.Essentials.pfComponent(
  ...
  replaceable
    ...
    pqflag=false,
    pflag=false,
    vcmpflag=vcmpflag) annotation (choicesAllMatching=true, Placement(transformation(
          extent={{-20,-20},{20,20}})));
  ...
  Modelica.Blocks.Math.Gain gain4(k=1)
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-60,-86})));
  Modelica.Blocks.Sources.Constant WG(k=0)
    annotation (Placement(transformation(extent={{-62,-74},{-52,-64}})));
  Modelica.Blocks.Sources.Constant PAUX(k=0)
    annotation (Placement(transformation(extent={{-62,-58},{-52,-48}})));
protected
...
equation
  connect(RenewableController.Iqcmd, RenewableGenerator.Iqcmd)
    annotation (Line(points={{20.5405,8.125},{23.9048,8.125},{23.9048,11.4286},{
  ...
  connect(gain1.y, RenewableController.Qext) annotation (Line(points={{-12.6,-80},
          {-32,-80},{-32,-2.625},{-21.0811,-2.625}},     color={0,0,127}));
  connect(gain.y, RenewableController.Pref) annotation (Line(points={{-12.6,-60},
          {-30,-60},{-30,-7.5},{-21.0811,-7.5}},         color={0,0,127}));
  ...
  connect(gain2.y, RenewableController.Pref) annotation (Line(points={{-79.4,80},
          {-36,80},{-36,22},{-34,22},{-34,-7.5},{-21.0811,-7.5}}, color={0,0,127}));
  ...
  connect(RenewableController.Wg, WG.y) annotation (Line(points={{-21.0811,
          -12.25},{-28,-12.25},{-28,-69},{-51.5,-69}}, color={0,0,127}));
  connect(RenewableController.Paux, PAUX.y) annotation (Line(points={{-21.0811,
          -16.625},{-24,-16.625},{-24,-53},{-51.5,-53}}, color={0,0,127}));
  connect(RenewableController.It, RenewableGenerator.I_t) annotation (Line(
        points={{-21.0811,12.875},{-32,12.875},{-32,38},{44,38},{44,21.4286}},
        color={0,0,127}));
  connect(RenewableController.i0, RenewableGenerator.I_0) annotation (Line(
        points={{7.02703,-21.125},{7.02703,-34},{54.8571,-34},{54.8571,-21.4286}},
        color={0,0,127}));
